    ...
    <div className="page_company">
      ...
      <section className="sec_2">
        <div className="flex">
          <div className="txt_w">
            ...
            <h1 className="quote">Advancing Science, <br/>Creating Real-World Impact</h1>
            <span className="quote">기초 연구에서부터 응용과 개발 단계까지 연구 전 과정을 유기적으로 연결하며, 검증 가능하고 재현성 있는 연구 성과를 현실적인 솔루션으로 확장하는 것을 목표로 합니다.</span>
          </div>
          <div className="sym_w">
        ...
        <div className="flex flex_reverse">
          ...
          <div className="txt_w">
            ...
            <h1 className="quote">Science with Purpose</h1>
            <span className="quote">데이터의 정확성, 실험의 재현성, 그리고 결과의 적용 가능성을 연구의 핵심 기준으로 삼아 단기적인 성과보다 장기적인 가치에 집중합니다.</span>
          </div>
        </div>
      </section>

      <section className="sec_3">
        <div className="sym_w sec_3_bg">
          <img className="pc" src="/company_s_3.jpg" />
          <img className="mob" src="/company_s_3_mob.jpg" />
      ...
      <section className="sec_4">
        <div className="float-wrap">
          <div className="sec_4_title quote" >
            Our Business<br/>History
          </div>
          <ul>
            <li>
              <h4 className="quote">2028</h4>
              <span className="quote">글로벌 연구 협력 네트워크 확대 및 공동 연구 프로젝트 진행</span>
              <span className="quote">연구 성과의 산업 적용을 위한 기술 이전 및 상용화 단계 진입</span>
            </li>

            <li>
              <h4 className="quote">2027</h4>
              <span className="quote">핵심 연구 플랫폼 고도화 및 데이터 분석 체계 강화</span>
              <span className="quote">다수의 연구 과제 수행을 통해 연구 파이프라인 확장</span>
            </li>

            <li>
              <h4 className="quote">2026</h4>
              <span className="quote">응용 연구 및 개발 단계 전략화</span>
              <span className="quote">연구 결과의 재현성 검증 및 표준화 프로세스 구축</span>
            </li>

            <li>
              <h4 className="quote">2025</h4>
              <span className="quote">연구 범위 확장 및 전문 인력 연구팀 강화</span>
              <span className="quote">데이터 기반 연구 환경 및 분석 인프라 도입</span>
            </li>

            <li>
              <h4 className="quote">2024</h4>
              <span className="quote">회사 설립 및 연구 인프라 구축</span>
              <span className="quote">기초 연구 중심의 초기 연구 프로젝트 착수</span>
            </li>
          </ul>
        </div>
      </section>
